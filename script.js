...
async function setupUser(user) {
    ...
    try {
        ...
        if (!userSnap.exists()) {
            ...
            const newUserData = { uid: user.uid, customId, email: user.email, balance: 10.00, referralCode, deviceGuid: getDeviceId(), status: "active", bankAccount: null, whatsAppNumber: null, dailyCheckin: { lastClaimed: null }, dailySpin: { lastSpun: null }, smsTask: { count: 0 }, createdAt: serverTimestamp(), referrerId: null };
